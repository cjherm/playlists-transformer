...
public class M3UPlaylistTransformerTest {
    ...
    public static final String ORIGIN_PLAYLIST_FILE_PATH = PATH_PLAYLISTS + "testPlayList.m3u";
    public static final String OUTPUT_FOLDER_PATH = PATH_RESOURCES + "\\output_folder";
    public static final String TRANSFORMED_PLAYLIST_FILE_PATH = PATH_RESOURCES + "\\testPlayList (transformed).m3u";
